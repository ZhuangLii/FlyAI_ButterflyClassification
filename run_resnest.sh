...
python main.py -c resnest.yaml SOLVER.BASE_LR 0.008 SOLVER.WARMUP_EPOCHS 8  SOLVER.MAX_EPOCHS 45 INPUT.GRAY_RPO 0.05 DATASETS.HARD_AUG simple MODEL.POOLING_METHOD GeM