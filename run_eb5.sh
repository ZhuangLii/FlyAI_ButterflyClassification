...
# best try gem simple auto hard
python main.py -c efficientnetb5.yaml SOLVER.BASE_LR 0.01 SOLVER.WARMUP_EPOCHS 2 SOLVER.MAX_EPOCHS 50 DATASETS.HARD_AUG simple MODEL.POOLING_METHOD GeM
